...
#SBATCH --job-name=eval_joint_savgol
...
# ===================================================================
# Eval ProtoNet zero-shot — joint + Savitzky-Golay (ep750)
# Mejor probe val R²=0.4687 (ep725). Dataset downstream: savgol.
...
CKPT="logs/gadf_soil_nir_joint_savgol/gadf_joint_savgol_ep800/gadf_joint_savgol-ep750.pth.tar"
DATA_PATH="data/SoilDataset_NIR_gadf2d_savgol"
NORM_STATS="data/gadf_norm_stats_v2_savgol.json"
EMB_ROOT="artifacts/embeddings/gadf_joint_savgol_ep750_mean"
K_SPT=25
K_QRY=25
BATCH_SIZE=64
OUTPUT="results/eval_joint_proto/gadf_joint_savgol_ep750_test_k${K_SPT}/"
...
# ==============================================================
echo ""
echo "[STEP 1] Precomputing embeddings from joint savgol target_encoder..."
