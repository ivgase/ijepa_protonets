...
#SBATCH --job-name=eval_joint_savgol_d1_transformer
...
# ===================================================================
# Eval ProtoNet zero-shot — joint + Savitzky-Golay deriv1 + cabeza transformer (ep800)
# Mejor probe val R²=0.4884 (ep625). Dataset downstream: savgol_d1.
...
CKPT="logs/gadf_soil_nir_joint_savgol_d1_transformer/gadf_joint_savgol_d1_transformer_ep800_continuous/gadf_joint_savgol_d1_transformer-ep800.pth.tar"
CONFIG="logs/gadf_soil_nir_joint_savgol_d1_transformer/gadf_joint_savgol_d1_transformer_ep800_continuous/params-joint.yaml"
DATA_PATH="data/SoilDataset_NIR_gadf2d_savgol_d1"
K_SPT=25
K_QRY=25
BATCH_SIZE=64
SAVE="results/eval_joint_proto/gadf_joint_savgol_d1_transformer_ep800_test_k${K_SPT}_with_proj/"
