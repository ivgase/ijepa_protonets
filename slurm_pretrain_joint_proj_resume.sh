#!/bin/bash
#SBATCH --job-name=pretrain_joint_proj_resume_ep600
...
echo "Config:   configs/gadf_soil_nir_joint_proj_resume.yaml"
echo "GPU:      cuda:0"
echo "Head:     ProjectionNet(768 -> 256 -> 128)"
echo "Proto:    mse  |  Lambda: 0.0025"
echo "Resume:   ep400 -> ep600  (coseno reiniciado, Opcion A)"
echo "Checkpoint: logs/gadf_soil_nir_joint_proj/gadf_joint_proj_20260413_172823/gadf_joint_proj-latest.pth.tar"
echo "=========================================="
echo ""
echo "NOTA: Al arrancar deben aparecer en el log:"
echo "  - 'loaded pretrained encoder from epoch 400' x3"
echo "  - 'Loaded proto_projection from checkpoint'"
...
CKPT_DIR="logs/gadf_soil_nir_joint_proj/gadf_joint_proj_20260413_172823"
...
python main_joint_pretrain.py \
    --fname configs/gadf_soil_nir_joint_proj_resume.yaml \
    --devices cuda:0
