...
# ===================================================================
# ijepa_spectra2d — ProtoNet from scratch, lr=1e-4, savgol (deriv=0)
#
# Objetivo: baseline ProtoNet from scratch con preprocesamiento
# Savitzky-Golay (window=15, poly=2, deriv=0).
# lr=1e-4 fue el mejor del sweep anterior (R²=0.411 sin preprocesar).
#
# Usage:
#   ./launch.sh slurm_protonet_scratch_savgol.sh "protonet scratch lr=1e-4 savgol deriv=0"
# ===================================================================
...
RUN_DIR="logs/gadf_soil_nir_protonet_scratch/savgol_${SLURM_JOB_ID}"
mkdir -p "$RUN_DIR"

echo "=========================================="
echo "Job ID:   $SLURM_JOB_ID"
echo "Node:     $SLURMD_NODENAME"
echo "Variante: savgol (deriv=0)"
...
echo "  grep 'AVERAGE' ${RUN_DIR}/savgol_*/eval_test/results_per_task.csv"
